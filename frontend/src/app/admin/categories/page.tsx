            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {filteredCategories.length === 0 ? (
                        <div className="col-span-1 sm:col-span-2 lg:col-span-3 bg-white rounded-2xl border border-gray-100 p-12 text-center">
                            <p className="text-gray-400">No categories found matching "{search}".</p>
                        </div>
                    ) : (
